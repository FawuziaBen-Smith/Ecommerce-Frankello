...
<div id="main-wrapper" class="section">
                                                ...
                                                <div class="all-cart-product clearfix">
                                                    <div class="single-cart clearfix">
                                                        <div class="cart-image">
                                                            <a href="product-details.php"><img src="../img/cart/food.jpeg" alt=""></a>
                                                        </div>
                                                        <div class="cart-info">
                                                    ...
                                                    <div class="single-cart clearfix">
                                                        <div class="cart-image">
                                                            <a href="product-details.php"><img src="../img/cart/2.jpeg" alt=""></a>
                                                        </div>
                                                        <div class="cart-info">
                                                            <h5><a href="product-details.php">Rice Mix</a></h5>
                                                            <p>1 x Ghs0.5</p>
                                                            <a href="#" class="cart-delete" title="Remove this item"><i class="fa fa-trash-o"></i></a>
                                                        </div>
                                                    </div>
    ...
    <div class="page-banner-section section" style="background-image: url(../img/hero/5.jpg)">
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            <div class="row flex-row-reverse">
                ...
                <div class="about-content col-lg-6 col-12 mb-30">
                    <h2>About <span>Frankello</span></h2>
                    <p>Frankello is a natural breakfast solution that is aimed at serving our customers with healthyb, affordable and hustle free breakfast. Frankello is owned by a young Ghanaian woman named Ellen Ocran.</p>
