                                                ...
                                                <div class="all-cart-product clearfix">
                                                    <div class="single-cart clearfix">
                                                        <div class="cart-image">
                                                            <a href="product-details.php"><img src="../img/cart/1.jpeg" alt=""></a>
                                                        </div>
                                                        <div class="cart-info">
                                                            <h5><a href="product-details.php">Tom Brown</a></h5>
                                                            <p>1 x £9.00</p>
            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-12 mb-30">
                    ...
                    <div class="single-product-image product-image-slider fix">
                        <div class="single-image"><img src="../img/cart/food.jpeg" alt=""></div>
                        <div class="single-image"><img src="../img/cart/2.jpeg" alt=""></div>
                        <div class="single-image"><img src="../img/cart/3.jpeg" alt=""></div>
                    </div>
                ...
                <div class="single-product-content col-lg-5 col-12 mb-30">
                    ...
                    <!-- Price -->
                    <span class="product-price">Ghs0.7</span>
                    
                    <!-- Description -->
                    <div class="description">
                        <p>Delicious meal made from corn, soya, beans, groundnut, wheat and salt</p>
                    </div>
            ...
            <div class="row">
                ...
                <div class="tab-content col-12">
                    ...
                    <div class="pro-info-tab tab-pane active" id="more-info">
                        <p>Frankello can be prepared by putting a desired quantity into a bowl and mixing it with water for some time. Then pour the mixture into  cooking sauce pan and stir it. It should be on fire for 8-10 minutes. After 8-10 minutes, food is ready! Enjoy!</p>
                    </div>
