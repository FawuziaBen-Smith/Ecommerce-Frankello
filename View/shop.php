            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-12 mb-60">
                    ...
                    <div class="product">
                        ...
                        <div class="image">
                            <!-- Image -->
                            <a href="product-details.php" class="img"><img src="../img/cart/food.jpeg" alt="Product"></a>
                            <!-- Wishlist -->
                        ...
                        <div class="content">
                            ...
                            <div class="head fix">
                                ...
                                <div class="title-category float-left">
                                    <h5 class="title"><a href="product-details.php">Tom Brown</a></h5>
                                    <a href="shop.php" class="category">Catalog</a>
                                </div>
                                <!-- Price -->
                                <div class="price float-right">
                                    <span class="new">Ghs0.5</span>
                ...
                <div class="col-lg-4 col-md-6 col-12 mb-60">
                    ...
                    <div class="product">
                        ...
                        <div class="image">
                            <!-- Image -->
                            <a href="product-details.php" class="img"><img src="../img/cart/2.jpeg" alt="Product"></a>
                            <!-- Wishlist -->
                            <a href="#" class="wishlist"><i class="fa fa-heart-o"></i></a>
                            <!-- Label -->
                            <!-- <span class="label">New</span> -->
                        ...
                        <div class="content">
                            ...
                            <div class="head fix">
                                ...
                                <!-- Title & Category -->
                                <div class="title-category float-left">
                                    <h5 class="title"><a href="product-details.php">Rice Mix</a></h5>
                                    <a href="shop.php" class="category">Catalog</a>
                                </div>
                                <!-- Price -->
                                <div class="price float-right">
                ...
                <div class="col-lg-4 col-md-6 col-12 mb-60">
                    ...
                    <div class="product">
                        ...
                        <div class="image">
                            <!-- Image -->
                            <a href="product-details.php" class="img"><img src="../img/cart/3.jpeg" alt="Product"></a>
                            <!-- Wishlist -->
                            <a href="#" class="wishlist"><i class="fa fa-heart-o"></i></a>
                            <!-- Label -->
                            <!-- <span class="label">New</span> -->
                        ...
                        <div class="content">
                            ...
                            <div class="head fix">
                                ...
                                <!-- Title & Category -->
                                <div class="title-category float-left">
                                    <h5 class="title"><a href="product-details.php">Wheat Mix</a></h5>
                                    <a href="shop.php" class="category">Catalog</a>
                                </div>
                                <!-- Price -->
                                <div class="price float-right">
                ...
                <div class="col-lg-4 col-md-6 col-12 mb-60">
                    ...
                    <div class="product">
                        ...
                        <div class="image">
                            <!-- Image -->
                            <a href="product-details.php" class="img"><img src="../img/cart/4.jpeg" alt="Product"></a>
                            <!-- Wishlist -->
                            <a href="#" class="wishlist"><i class="fa fa-heart-o"></i></a>
                            <!-- Label -->
                            <span class="label">New</span>
                        ...
                        <div class="content">
                            ...
                            <div class="head fix">
                                ...
                                <!-- Title & Category -->
                                <div class="title-category float-left">
                                    <h5 class="title"><a href="product-details.php">Jumbo Tom Brown</a></h5>
                                    <a href="shop.php" class="category">Catalog</a>
                                </div>
                                <!-- Price -->
                                <div class="price float-right">
                                    <span class="new">Ghs0.8</span>
                                    <!-- Old Price Mockup If Need -->
                                    <!-- <span class="old">$46</span> -->
                                </div>
                ...
                <div class="col-lg-4 col-md-6 col-12 mb-60">
                    ...
                    <div class="product">
                        ...
                        <div class="image">
                            <!-- Image -->
                            <a href="product-details.php" class="img"><img src="../img/cart/5.jpeg" alt="Product"></a>
                            <!-- Wishlist -->
                            <a href="#" class="wishlist"><i class="fa fa-heart-o"></i></a>
                            <!-- Label -->
                            <!-- <span class="label">New</span> -->
                        ...
                        <div class="content">
                            ...
                            <div class="head fix">
                                ...
                                <!-- Title & Category -->
                                <div class="title-category float-left">
                                    <h5 class="title"><a href="product-details.php">Jumbo Rice Mix</a></h5>
                                    <a href="shop.php" class="category">Catalog</a>
                                </div>
                                <!-- Price -->
                                <div class="price float-right">
                ...
                <div class="col-lg-4 col-md-6 col-12 mb-60">
                    ...
                    <div class="product">
                        ...
                        <div class="image">
                            <!-- Image -->
                            <a href="product-details.php" class="img"><img src="../img/cart/6.jpeg" alt="Product"></a>
                            <!-- Wishlist -->
                            <a href="#" class="wishlist"><i class="fa fa-heart-o"></i></a>
                            <!-- Label -->
                            <!-- <span class="label">New</span> -->
                        ...
                        <div class="content">
                            ...
                            <div class="head fix">
                                ...
                                <!-- Title & Category -->
                                <div class="title-category float-left">
                                    <h5 class="title"><a href="product-details.php">Jumbo Wheat Mix</a></h5>
                                    <a href="shop.php" class="category">Catalog</a>
                                </div>
                                <!-- Price -->
                                <div class="price float-right">
